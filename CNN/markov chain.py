...
# P[0][0] - ймовірність з "Сонячно" в "Сонячно"
# P[0][1] - ймовірність з "Сонячно" в "Дощ"
# P[1][0] - ймовірність з "Дощ" в "Сонячно"
# P[1][1] - ймовірність з "Дощ" в "Дощ"
P = np.array([[0.7, 0.3],
              [0.4, 0.6]])

# Початковий стан (наприклад, сьогодні сонячно)
current_state = 0  # 0 відповідає "Сонячно", 1 - "Дощ"

# Кількість днів для прогнозу
num_days = 50

# Зберігаємо історію станів
